...
import { ArrowUpRight, MessageCircleMore } from "lucide"
...
export function SocialActions({ whatsappHref }: SocialActionsProps) {
  return (
    <>
      <a
        href="https://www.facebook.com/shopaionsite"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/shopaionsite/"
        target="_blank"
        rel="noopener noreferrer"
        className="h-9 w-9 rounded-full bg-muted/50 flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors"
