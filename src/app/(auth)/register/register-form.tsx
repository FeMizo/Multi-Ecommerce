...
const accountTypes = ["SELLER", "BUYER"] as const
...
const TYPE_META: Record<AccountType, { title: string; description: string; icon: typeof User; accent: string }> = {
  SELLER: {
    title: "Vendedor",
    description: "Crea tu tienda y administra productos y pedidos.",
    icon: Shield,
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16">
          ...
          <p className="text-primary-foreground/80 text-lg mb-8 max-w-md">
            Crea una cuenta de vendedor o comprador en un solo flujo.
          </p>
        </div>
      </div>
